          ...
          {milestones.map((milestone) => {
            ...
            return (
              <div key={milestone.id} className="flex gap-4">
                ...
                {/* Card */}
                <div
                  className={`flex-1 rounded-lg border ${styles.border} ${styles.bg} p-4 transition-all hover:scale-[1.01]`}
                >
                  ...
                  {milestone.linkTo && (
                    <Link
                      to={milestone.linkTo}
                      className="text-indigo-600 dark:text-indigo-400 text-sm font-medium inline-block mt-2"
                    >
                      View milestone →
                    </Link>
                  )}
